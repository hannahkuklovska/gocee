...
int main()
{
    ...
    loadSourceData("C:/Users/puvak/Downloads/BL-902.dat", B_source, L_source, H_source);
    loadMeasurementData("C:/Users/puvak/Downloads/BL-3602.dat", B_measurement, L_measurement, H_measurement);
